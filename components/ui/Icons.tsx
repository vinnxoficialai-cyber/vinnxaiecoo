...
export const MenuIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="4" y1="12" x2="20" y2="12"></line><line x1="4" y1="6" x2="20" y2="6"></line><line x1="4" y1="18" x2="20" y2="18"></line></svg>
);
...
export const TrophyIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"></path><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"></path><path d="M4 22h16"></path><path d="M10 14.66V17"></path><path d="M14 14.66V17"></path><path d="M18 2h-4a4 4 0 0 0-8 0H4a2 2 0 0 0-2 2v2.5a4.5 4.5 0 0 0 4.5 4.5c.97 0 1.9-.3 2.67-.84.27 1.34 1.3 2.44 2.83 2.84V17a2 2 0 0 0-2 2v1h8v-1a2 2 0 0 0-2-2v-1.66c1.53-.4 2.56-1.5 2.83-2.84A4.48 4.48 0 0 0 22 6.5V2a2 2 0 0 0-2-2Z"></path></svg>
);
...
export const GoogleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className={className}>
    <g transform="matrix(1, 0, 0, 1, 0, 0)">
      <path fill="#4285F4" d="M23.745,12.27c0-0.743-0.064-1.465-0.182-2.165H12.25v4.29h6.477c-0.279,1.514-1.13,2.797-2.408,3.655v3.023h3.896c2.28-2.096,3.529-5.185,3.529-8.803z"></path>
      <path fill="#34A853" d="M12.25,24c3.235,0,5.949-1.077,7.931-2.906l-3.896-3.023c-1.071,0.72-2.446,1.144-4.035,1.144c-3.116,0-5.756-2.106-6.703-4.936H1.365v3.13C3.344,21.353,7.502,24,12.25,24z"></path>
      <path fill="#FBBC05" d="M5.547,14.279c-0.24-0.725-0.38-1.503-0.38-2.279s0.14-1.554,0.38-2.279V6.591H1.365C0.495,8.324,0,10.297,0,12.279s0.495,3.955,1.365,5.688L5.547,14.279z"></path>
      <path fill="#EA4335" d="M12.25,4.717c1.76,0,3.342,0.607,4.584,1.795l3.435-3.447C18.196,1.13,15.485,0,12.25,0C7.502,0,3.344,2.647,1.365,6.591l4.182,3.13C6.494,6.823,9.134,4.717,12.25,4.717z"></path>
    </g>
  </svg>
);
